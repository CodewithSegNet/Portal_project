    ...
    link.addEventListener("click", function (event) {
      ...
      fetch(`/students/dashboard?page=${page}`)
        ...
        .then((data) => {
          ...
          const updatedNotifications = doc.querySelector(
            "#notifications .all-notification",
          );
          const updatedPagination = doc.querySelector(
            "#notifications .pagination",
          );

          // Replace the current notifications and pagination
          document.querySelector("#notifications .all-notification").innerHTML =
            updatedNotifications.innerHTML;
          document.querySelector("#notifications .pagination").innerHTML =
            updatedPagination.innerHTML;
...
function showMessage(topic, date, fullMessage) {
  ...
  document.getElementById("message-topic").innerText =
    topic || "No topic available";
  document.getElementById("message-date").innerText =
    date || "No date available";
  document.getElementById("message-body").innerText =
    fullMessage || "No message available";
